...
| **FE-10 Dashboard page** | the last PRD page, built on the design system, the size classes and the transitions | FE-09, BE-06 | Playwright scenario + `ux-audit.py --pages /dashboard` |
